defmodule Storybook.Foundations.FontsDeprecated do
  ...
  def description, do: "Deprecated font families — superseded by --font-family-* foundation tokens."
  ...
  def render(assigns) do
    ...
    <div style="font-family: var(--zaq-font-primary, sans-serif); padding: 2rem; display: flex; flex-direction: column; gap: 3rem; max-width: 760px;">
      <div style="background: rgba(234, 0, 62, 0.06); border: 1px solid rgba(234, 0, 62, 0.25); border-radius: 8px; padding: 0.75rem 1rem; font-size: 0.75rem; line-height: 1.5; color: inherit;">
        ...
        Use <code style="font-family: ui-monospace, monospace; font-size: 0.8em;">--font-family-heading</code>,
        <code style="font-family: ui-monospace, monospace; font-size: 0.8em;">--font-family-body</code>, and
        <code style="font-family: ui-monospace, monospace; font-size: 0.8em;">--font-family-code</code>
        defined in <strong style="font-weight: 600;">Foundation / Fonts</strong> instead.
      </div>
