defmodule Storybook.Foundations.Spacing do
  ...
  def render(assigns) do
    ...
    <div style="font-family: var(--zaq-font-primary, sans-serif); padding: 2rem; display: flex; flex-direction: column; gap: 0.5rem; max-width: 600px;">
      ...
      <.scale_row token="--scale-42" label="48" px="48px" />
  ...
  defp scale_row(assigns) do
    ...
    <div style="display: grid; grid-template-columns: 48px 1fr 140px; align-items: center; gap: 1rem; padding: 0.3rem 0;">
      ...
      <div style={"height: 12px; border-radius: 3px; background: var(--zaq-color-accent, #03b6d4); width: var(#{@token}, #{@px}); min-width: 2px;"}>
      </div>
