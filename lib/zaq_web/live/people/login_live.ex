  ...
  def render(assigns) do
    ...
    <AuthLayout.auth_layout heading="Sign in to ZAQ" subtitle="Authorization Required">
      ...
      <div
        ...
        data-auto-dismiss-duration={5000}
      >
      ...
      <div
        ...
        id="flash-error"
        role="alert"
        class="zaq-feedback-banner zaq-danger zaq-text-body zaq-feedback-banner--shake"
      >
        <span class="zaq-feedback-icon">
          <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <%= if @challenge do %>
        ...
        <div
          ...
          data-resend-available-at={@resend_available_at && DateTime.to_iso8601(@resend_available_at)}
        >
          <.form
            for={@code_form}
            id="people-code-form"
          ...
          >
            ...
            <Button.button type="submit" variant={:primary} class="w-full uppercase">
              Sign in
            </Button.button>
          </.form>
